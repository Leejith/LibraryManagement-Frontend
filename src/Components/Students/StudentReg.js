      ...
      <div class="container text-center std-reg ">
        <div class="row">
          ...
          <div class="col-lg-7 col-md-6 col-sm-12 order-sm-2 ">
            <form class="std-form" onSubmit={handleSubmit}>
              <h1 class="mt-4">REGISTER FORM</h1>

              {/* profile card           */}
              <div class="mb-2   profile-pic d-flex ">
              ...
              <div class="form-group std-form">
                <div class="input-group ">
                  <span class="input-group-text reg-stdname">
                    <i class="ri-user-fill"></i>
                  </span>
                  <input
                    type="text"
                    class="form-control reg-stdname"
                    name="Name"
              ...
              <div class="form-group std-form ">
                <div class="input-group ">
                  <span class="input-group-text reg-stddep">
                    <i class="ri-id-card-line"></i>
                  </span>
                  <input
                    type="text"
                    class="form-control reg-stddep"
                    name="Department"
              ...
              <div class="form-group std-form ">
                <div class="input-group ">
                  <span class="input-group-text reg-stdno">
                    <i class="ri-registered-line"></i>
                  </span>
                  <input
                    type="number"
                    class="form-control reg-stdno"
                    name="Regno"
              ...
              <div class="form-group std-form ">
                <div class="input-group ">
                  <span class="input-group-text reg-stdemail">
                    <i class="ri-mail-line"></i>
                  </span>
                  <input
                    type="email"
                    class="form-control reg-stdemail"
                    name="email"
              ...
              <div class="form-group std-form ">
                <div class="input-group ">
                  <span class="input-group-text reg-stdpass">
                    <i class="ri-lock-password-line"></i>
                  </span>
                  <input
                    type="password"
                    class="form-control reg-stdpass"
                    name="password"
              ...
              <button type="submit" class="btn reg-stdbtn ">
                REGISTER
              </button>
            </form>
          </div>
